...
class CleanCurrentClipboardTileService : TileService() {
    override fun onStartListening() {
        ...
        qsTile?.apply {
            icon = Icon.createWithResource(this@CleanCurrentClipboardTileService, net.wastu.cleancopy.R.drawable.ic_clean_current_clipboard)
            label = getString(net.wastu.cleancopy.R.string.tile_clean_current)
