...
import net.wastu.cleancopy.CleanMediaActivity

class CleanCopyTileService : TileService() {
    override fun onStartListening() {
        super.onStartListening()
        qsTile?.apply {
            icon = Icon.createWithResource(this@CleanCopyTileService, net.wastu.cleancopy.R.drawable.ic_choose_media_copy)
            label = getString(net.wastu.cleancopy.R.string.tile_clean_copy)
